...
from ADAPET.src.eval.eval_model import dev_eval
...
from ADAPET.src.utils.util import get_avg_dict_val_store, update_dict_val_store, ParseKwargs
from ADAPET.src.utils.util import set_global_logging_level, device
...
def train(config, use_saved_model=False, model_dir="", return_model=False):
    '''
    Trains the model
    ...
    :return:
    '''
    # print(config.pretrained_weight)
