...
from ADAPET.src.data.BoolQReader import BoolQReader
from ADAPET.src.data.CBReader import CBReader
from ADAPET.src.data.RTEReader import RTEReader
from ADAPET.src.data.MultiRCReader import MultiRCReader
from ADAPET.src.data.WiCReader import WiCReader
from ADAPET.src.data.COPAReader import COPAReader
from ADAPET.src.data.RecordReader import RecordReader
from ADAPET.src.data.WSCReader import WSCReader
from ADAPET.src.data.CySecReader import CySecReader
from ADAPET.src.data.SpecializedCySecReader import SpecializedCySecReader
...
class DatasetReader(object):
    ...
    def __init__(self, config, tokenizer, dataset):
        ...
        elif self.dataset.lower() == "cysec/generalcysec":
            self.dataset_reader = CySecReader(self.config, tokenizer)
        elif self.dataset.lower() == "cysec/specializedcysec":
            self.dataset_reader = SpecializedCySecReader(self.config, tokenizer)
        else:
