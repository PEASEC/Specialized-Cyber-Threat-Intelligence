...
def save_augmented_data(data, augmented_class):
    ...
    with open(os.path.join(os.environ["PROJECT_ROOT"], "msexchange-server-cti-dataset", "augmented", 'train_' + suffix + '.pkl' ), 'wb') as outfile:
        pickle.dump(augmented_data, outfile)
